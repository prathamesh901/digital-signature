        ...
        <div className="min-h-screen flex flex-col justify-between">
            ...
            <div className="bg-white py-4 shadow-md">
                <div className="flex gap-4 flex-row justify-around md:justify-start flex-wrap">
                    ...
                    <CustomButton
                        onClick={() => downloadSignatureAsPNG(signaturePad)}
                    ...
                    <CustomButton
                        onClick={() => downloadSignatureAsJPG(signaturePad)}
                        bgColor="bg-green-100"
                        textColor="text-green-800"
                        borderColor="border-green-400"
                        darkBgColor="dark:bg-gray-700"
                    ...
                    <CustomButton
                        onClick={() => downloadSignatureAsSVG(signaturePad)}
                        bgColor="bg-green-100"
                        textColor="text-green-800"
                        borderColor="border-green-400"
                        darkBgColor="dark:bg-gray-700"
                    ...
                    <CustomButton
                        onClick={() => downloadSignatureAsSVG(signaturePad, true)}
                        bgColor="bg-green-100"
                        textColor="text-green-800"
                        borderColor="border-green-400"
                        darkBgColor="dark:bg-gray-700"
